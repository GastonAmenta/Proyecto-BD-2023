...
<div class='container'>
    <div class="container-header">
        ...
        <button>Provincias compas</button>
        <button>Turnos web</button>
        <button>BIP Personas</button>
        <button>BIP Empresas</button>
    </div>
    <div id="carouselExampleSlidesOnly" class="carousel slide container-carrusel" data-bs-ride="carousel">
